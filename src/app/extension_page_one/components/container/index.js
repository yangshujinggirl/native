...
export default class Container extends Component{
  ...
  updateValue=(text,type,isTrue,errorText)=>{
	...
	//弹窗按钮1点击事件 暂不认证
  btn1Click=()=>{
    window.location.href='../extension_pagefail_one/extension_pagefail_one.html?success=false';
  }
  ...
  togglePsd=()=>{
        ...
        if(strUtil.isEmpty(this.state.phoneCodeErrorText)){
          ...
          if(strUtil.isEmpty(this.state.psdErrorText)){
              ...
              let successCall=(data)=>{
                ...
                window.location.href='../extension_pageSucess_one/extension_pageSucess_one.html?success=false';
              }
              let errorCall=(data)=>{
                this.setState({isLoading: false});
    ...
    var button=dealBtn();
		...
		let getPhone=()=>{
          ...
          successUrl='../extension_pagefail_one/extension_pagefail_one.html?success=true'/>
			}else{
