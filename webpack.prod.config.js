...
var entry={
     ...
     */
      ...
      * @type {String}
      */
     product_list:'./src/app/product_list/app.js',
     /**
      * 活动列表
      * @type {String}
      */
     activity_list:'./src/app/activity_list/app.js',
    ...
    * */
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            ...
            keywords: '投资',
            description: '投资',
            filename: './product_list/product_list.html',
            template:  './src/app/common/common.html',
            chunks: ['vendor','product_list'],
            inject: true,
            hash: true
        }),
        new HtmlWebpackPlugin({
            ...
            keywords: '热门活动',
            description: '热门活动',
            filename: './activity_list/activity_list.html',
            template:  './src/app/common/common.html',
            chunks: ['vendor','activity_list'],
            inject: true,
            hash: true
        }),
        /**
