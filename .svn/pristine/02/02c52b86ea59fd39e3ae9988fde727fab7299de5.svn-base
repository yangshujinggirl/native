...
import 'fetchJs';
import 'whatwg-fetch';
import { config,strUtil,dataUtil,bussinessUtil,sessionUtil,urlUtil,localStorageUtil,setCookie} from 'publicJs';
       ...
       <div className="login">
        <div className="user-login">
          ...
          <Alert  type='3'
            ...
            btn1Text='取消'
            btn2Text='去开通'
            btn1Click={this.btn1Click}
            btn2Click={this.btn2Click}>
